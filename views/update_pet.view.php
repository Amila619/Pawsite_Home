        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body p-4">
                    <h3 class="text-center mb-4">Update Pet</h3>
                    <form action="../../Pawsitive_Home/core/handle_update_pet.php?img_url=<?php echo $pet['img_url'] ?>&pet_id=<?php echo $pet['pet_id'] ?>" method="POST" id="addPetForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <img id="upload_pet_dp" src="../<?php echo $pet['img_url'] ?>" alt="Pet Image" style="max-width: 80px; height: auto; border: 2px solid #ccc;">
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-custom">Update Pet</button>
                    </form>
                </div>
            </div>
        </div>
